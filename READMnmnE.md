...
<head>
  <meta charset="UTF-8" />
  <title>FluidBook - Creative & Fluid Apple-Inspired Design</title>
  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    .hero {
      text-align: center;
      margin-bottom: 6rem;padding: 4rem 1rem 2rem;
    }
    .hero h1 {
      font-family: 'Open Sans', sans-serif;
      font-weight: 900;
      ...
      background: conic-gradient(from 0deg, #0071e3, #00c6ff, #0071e3);
      background-size: 200% 200%;
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      animation: rainbow-x 15s ease-in-out infinite alternate;
      user-select: none;
      margin-bottom: 1rem;
      line-height: 1.05;
